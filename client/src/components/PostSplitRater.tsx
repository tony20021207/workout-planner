        ...
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1">
            ...
            <p className="text-xs text-muted-foreground leading-relaxed mt-1">
              You used OptiSplit and OptiFill without editing — the result already satisfies the Hypertrophy Matrix criteria for your experience level. Make any change (move an exercise, edit sets / reps, swap a pick) and the post-split rating button will reappear so you can re-score.
            </p>
          </div>
          <RatingRubric />
        </div>
